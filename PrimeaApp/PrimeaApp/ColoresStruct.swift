...
//  PrimeaApp
//
//  Created by Wilman Garcia De Leon on 12/13/15.
...
struct Datos {
    let Fraces = ["Somos lo que pensamos. Todo lo que somos surge con nuestros pensamientos. Con nuestros pensamientos construimos el mundo.-Buddha.",
    ...
    func RegresaFrase()->String {
        
//        let randomNumber0Totot =  Int(arc4random_stir()) % Fraces.count
      let randomNumber0To8 = Int(arc4random_uniform(119))
        return Fraces[randomNumber0To8]
    }
